  ...
  return (
    <PageLayout hideFooter>
      ...
      <div className="min-h-screen bg-gray-50">
        {/* Hero Section */}
        <section className="bg-gradient-to-r from-[#0b1f3a] via-[#153a5f] to-[#3fa2a3] text-white pt-10 pb-12 sm:pt-14 sm:pb-16">
        ...
        <section className="py-12 sm:py-14">
          <div className="mx-auto w-full max-w-[1240px] px-4 sm:px-6 lg:px-8">
            ...
            >
              <div className="mb-4">
                <h2 className="text-3xl font-bold text-[#0b1f3a]">Send us a Message</h2>
                <div className="mt-3 h-1.5 w-24 rounded-full bg-gradient-to-r from-[#f7a236] to-[#3fa2a3]" />
              </div>
              <p className="mt-2 text-base text-gray-600">Tell us about your needs and we’ll help you with the right mobility solution.</p>
              <div className="mt-6">
                <ContactForm />
              </div>
            </motion.div>
            ...
            >
              <div className="mb-4">
                <h2 className="text-3xl font-bold text-[#0b1f3a]">Get in Touch</h2>
                <div className="mt-3 h-1.5 w-24 rounded-full bg-gradient-to-r from-[#f7a236] to-[#3fa2a3]" />
              </div>
              <p className="mt-2 text-base text-gray-600">We’re here to answer your questions and guide you every step of the way.</p>
              ...
              <div className="mt-8 grid grid-cols-1 gap-6 md:grid-cols-2">
                <div className="rounded-[22px] border border-[#0b1f3a]/10 bg-white/80 p-6 shadow-sm">
                  ...
                  <h3 className="mb-2 text-lg font-semibold text-[#0b1f3a]">Visit Our Office</h3>
                ...
                <div className="rounded-[22px] border border-[#0b1f3a]/10 bg-white/80 p-6 shadow-sm">
                  ...
                  <h3 className="mb-2 text-lg font-semibold text-[#0b1f3a]">Call Us</h3>
                ...
                <div className="rounded-[22px] border border-[#0b1f3a]/10 bg-white/80 p-6 shadow-sm">
                  ...
                  <h3 className="mb-2 text-lg font-semibold text-[#0b1f3a]">Email Us</h3>
                  <a
                ...
                <div className="rounded-[22px] border border-[#0b1f3a]/10 bg-white/80 p-6 shadow-sm">
                  ...
                  <h3 className="mb-2 text-lg font-semibold text-[#0b1f3a]">Business Hours</h3>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="rounded-[24px] border border-[#0b1f3a]/10 bg-white p-8 text-center shadow-[0_15px_40px_rgba(11,31,58,0.06)]">
                ...
                <h3 className="mb-2 text-xl font-semibold text-[#0b1f3a]">Free Consultation</h3>
              ...
              <div className="rounded-[24px] border border-[#0b1f3a]/10 bg-white p-8 text-center shadow-[0_15px_40px_rgba(11,31,58,0.06)]">
                ...
                <h3 className="mb-2 text-xl font-semibold text-[#0b1f3a]">Quick Response</h3>
                <p className="text-gray-600">
              ...
              <div className="rounded-[24px] border border-[#0b1f3a]/10 bg-white p-8 text-center shadow-[0_15px_40px_rgba(11,31,58,0.06)]">
                ...
                <h3 className="mb-2 text-xl font-semibold text-[#0b1f3a]">Expert Support</h3>
                <p className="text-gray-600">
