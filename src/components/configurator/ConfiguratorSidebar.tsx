                ...
                <div className="flex items-center">
                  <button
                    ...
                    className={`configuration-category-item flex-1 flex items-center px-3 py-2 text-sm font-medium rounded-md transition-colors duration-150 ${
                      isActive
                        ? 'configuration-category-active bg-teal-100 text-brand-primary border-l-4 border-teal-600'
                        : hasError
      ...
      <div className="configuration-progress-bar p-4 border-t border-gray-200 bg-gray-50">
        <div className="text-sm text-gray-600">
          ...
          <div className="mt-2 bg-gray-200 rounded-full h-2">
            <div 
              className="configuration-progress-fill bg-brand-primary h-2 rounded-full transition-all duration-300"
              style={{
